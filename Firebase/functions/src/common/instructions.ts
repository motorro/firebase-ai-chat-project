...
import {calculateDispatcher, divideDispatcher} from "./calculator";
import {FunctionDeclarationSchemaType} from "@google-cloud/vertexai";

export const calculatorMainInstructions: VertexAiSystemInstructions<CalculateChatData> = {
    instructions: `
...
The assistant will handle the request and send you the new accumulated value when ready.
        ...
        definition: [
            {
                functionDeclarations: [
                    ...
                    },
                    {
                        name: "subtract",
                        // eslint-disable-next-line max-len
                        description: "Subtracts supplied argument from the accumulated value and returns new value in the 'data' field or an error if there is an error",
                        parameters: {
                            type: FunctionDeclarationSchemaType.OBJECT,
                            properties: {
                                value: {
...
export const calculatorDividerInstructions: VertexAiSystemInstructions<CalculateChatData> = {
    instructions: `
